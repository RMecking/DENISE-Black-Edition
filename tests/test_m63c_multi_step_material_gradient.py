...
def test_locked_and_active_paths_remain_untouched(repository_root:Path):
 paths=["src/SH/visco_sh_full_state_adjoint_step.c","src/SH/visco_sh_material_timestep_vjp.c","src/SH/visco_sh_material_gradient_assembly.c","src/SH/matcopy_SH_adjoint.c","src/SH/visco_sh_material_observable.c","src/SH/FWI_SH.c","src/SH/FWI_SH_visc.c","src/SH/grad_obj_sh.c","src/SH/grad_obj_sh_visc.c"]
